...
cd /d/George/ICT/Paper/CS229-MachineLearning/videos || exit 1
...
echo "=== CS229 Autumn 2018 ==="
DL_PLAYLIST "https://www.youtube.com/playlist?list=PLoROMvodv4rMiGQp3WXShtMGgzqpfVfbU"
echo "=== CS229 Summer 2019 ==="
DL_PLAYLIST "https://www.youtube.com/playlist?list=PLoROMvodv4rNH7qL6-efu_q2_bPuy0adh"
echo "=== CS229 ALL DONE ==="
